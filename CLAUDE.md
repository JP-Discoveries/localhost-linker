...
Built with Tauri v2 for Windows, macOS and Linux. Windows is tested on real hardware; macOS and
Linux are built by CI (`.github/workflows`) but not yet hand-tested, and releases ship unsigned. See `README.md` for how it works, how to run
